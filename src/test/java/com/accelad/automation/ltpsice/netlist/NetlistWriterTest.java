...
import com.accelad.automation.ltpsice.netlist.element.*;

public class NetlistWriterTest {

    @Test
    public void should_return_valid_netlist() throws Exception {
        ...
        netlist.addElement(new com.accelad.automation.ltpsice.netlist.element.Subcircuit(new InstanceName("0S"), Arrays
                .asList(nodeA, nodeB, nodeC, nodeD), new Model("12")));
        ...
        assertEquals("* title\n" + "B0BCS a b 1\n" + "B0BVS a b 2\n" + "Q0BJT a b c 3\n" + "C0C a b 4\n" + "F0CCC a b c 5\n" + "H0CCV a b c 6\n" + "D0BVS a b 7\n" + "I0ICS a b 8\n" + "V0IVS a b 9\n" + "L0I a b 10\n" + "R0R a b 11\n" + "X0S a b c d 12\n" + "GVCC a b c d 13\n" + "EVCV a b c d 14\n" + "\n" + ".OP\n" + ".END", baos.toString().replaceAll("\r", "").trim());
    }
}
